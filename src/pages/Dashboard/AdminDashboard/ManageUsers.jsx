...
//     // return res.data;
//     const res = await fetch("https://assignment-12-server-engarif3.vercel.app/users");
//     return res.json();
//   });
...
//       fetch(`https://assignment-12-server-engarif3.vercel.app/users/instructor/${user._id}`, {
//         method: 'PATCH',
//       })
//         .then((res) => res.json())
//         .then((data) => {
...
const ManageUsers = () => {
  ...
  const handleAdmin = (user) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`https://assignment-12-server-engarif3.vercel.app/users/admin/${user._id}`, {
          method: "PATCH",
        })
          .then((res) => res.json())
          .then((data) => {
